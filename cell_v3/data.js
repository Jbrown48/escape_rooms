    ...
    },
    {
      ...
      infoHotspots: [
        ...
        },
        {
          ...
          text: "<div>Dive deep into the Endoplasmic Reticulum to learn how cells harness energy. Complete the interactive tutorial and quiz on cellular respiration.</div><div><br></div><div>Your next challenge takes you to the bustling world of the Endoplasmic Reticulum, where the intricate process of cellular respiration unfolds.Engage in an interactive tutorial to learn how cells convert nutrients into energy. This is a vital step in understanding the cell's energy dynamics. After completing the tutorial, a short quiz awaits to test your newfound knowledge. Success here is key to unlocking the next part of your escape.</div><div><div><br/><a href='https://tinyurl.com/yxbhnazk' target='_blank'>*****Quiz #2*****</a></div><br/><div><strong>Resources:</strong><br/><a href='https://www.khanacademy.org/' target='_blank'>Khan Academy</a></div></div><div><br></div>",
        },
        {
