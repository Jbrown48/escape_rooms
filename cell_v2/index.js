...
(function () {
  ...
  var scenes = data.scenes.map(function (data) {
    ...
    // Create info hotspots.
    data.hintHotspots.forEach(function (hotspot) {
  ...
  function createHintHotspotElement(hotspot) {
    ...
    wrapper.classList.add("hintspot");

    // Create image element.
    var icon = document.createElement("img");
    icon.src = "img/link.png";
    icon.classList.add("hint-hotspot-icon");
    ...
    wrapper.addEventListener("click", function () {
      // Hardcoded link
      var hardcodedLink = "https://www.marzipano.net/demos.html";

      // Open the hardcoded link in a new window
      window.open(hardcodedLink, "_blank");
    });
    ...
    tooltip.classList.add("hint-hotspot-tooltip");

    wrapper.appendChild(icon);
    wrapper.appendChild(tooltip);

    // Set the text content of the tooltip
    tooltip.textContent = "Get to the Choppa!";
    ...
    wrapper.addEventListener("mouseout", function () {
      // On mouseout, set opacity back to 0
      tooltip.style.opacity = 0;
    });
